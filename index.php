...
<!-- index-sp-layout109:18-->

<head>

  <!-- Meta Tags -->
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
  <meta http-equiv="content-type" content="Driving/School; charset=UTF-8" />
  <meta name="description" content="Aliz Driving School | Best in Town Ilford State London" />
  <meta name="keywords"
    content=" Driving, Driving School, Aliz Driving School, School, #, learning, Driving School Ilford State London" />


  <!-- Page Title -->
  <title>Aliz-Driving School</title>
          ...
          <div class="container">
            <nav id="menuzord-right" class="menuzord default">
              <a class="menuzord-brand pull-left flip" href="javascript:void(0)">
                <img src="images/logo-wide.jpg" alt="">
              </a>
            ...
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway" id="rs-1-layer-1"
                  ...
                  style="z-index: 7; white-space: nowrap; font-weight:700;">Driving
                </div>
                ...
                <div
                  ...
                  data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                  data-splitout="none" data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;">Driving For EveryOne
                </div>

                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white" id="rs-1-layer-3" data-x="['left']" data-hoffset="['35']"
                  data-y="['middle']" data-voffset="['35']" data-fontsize="['16']" data-lineheight="['28']"
                  ...
                  data-splitout="none" data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">We provides always our
                  best services for our clients and always<br> try to achieve our client's trust and satisfaction.
                </div>
              ...
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg"
                data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg7.jpg" alt="" data-bgposition="center 40%" data-bgfit="cover"
                  data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
                ...
                <div
                  ...
                  id="rs-2-layer-1" data-x="['center']" data-hoffset="['0']" data-y="['middle']" data-voffset="['-90']"
                  data-fontsize="['28']" data-lineheight="['54']" data-width="none" data-height="none"
                  data-whitespace="nowrap" data-transform_idle="o:1;s:500"
                  data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                  data-transform_out="x:left(R);s:1000;e:Power3.easeIn;s:1000;e:Power3.easeIn;"
                  data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                ...
                <div
                  ...
                  id="rs-2-layer-2" data-x="['center']" data-hoffset="['0']" data-y="['middle']" data-voffset="['-20']"
                  data-fontsize="['48']" data-lineheight="['70']" data-width="none" data-height="none"
                  data-whitespace="nowrap" data-transform_idle="o:1;s:500"
                  data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                  data-transform_out="x:left(R);s:1000;e:Power3.easeIn;s:1000;e:Power3.easeIn;"
                  data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                  data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                  data-splitout="none" data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">Best Services In Town
                </div>
                ...
                <div class="tp-caption tp-resizeme" id="rs-2-layer-4" data-x="['center']" data-hoffset="['0']"
                  ...
                  <!-- <a class="btn btn-default btn-circled btn-transparent pl-20 pr-20" href="#">Apply Now</a> -->
                </div>
              </li>
              ...
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                ...
                <div
                  ...
                  id="rs-3-layer-1" data-x="['right']" data-hoffset="['30']" data-y="['middle']" data-voffset="['-90']"
                  data-fontsize="['64']" data-lineheight="['72']" data-width="none" data-height="none"
                  data-whitespace="nowrap" data-transform_idle="o:1;s:500"
                  data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                  data-transform_out="x:left(R);s:1000;e:Power3.easeIn;s:1000;e:Power3.easeIn;"
                  data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                  data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                  data-splitout="none" data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;">Best Practical Training
                </div>
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway" id="rs-3-layer-2"
                  ...
                  data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                  data-splitout="none" data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;">For Your Better Driving Careers
                </div>
            ...
            <div class="row equal-height-inner home-boxes" data-margin-top="-100px">
              ...
              <div
                ...
                <div class="sm-height-auto bg-theme-colored-darker2">
                  <div class="text-center pt-30 pb-30">
                    <i class="fa fa-comments-o text-white font-60"></i>
              ...
              <div
                ...
                <div class="sm-height-auto bg-theme-colored-darker3">
                  ...
                  <span
                    ...
                    data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                    data-splitout="none" data-responsive_offset="on"
                    style="z-index: 7; white-space: nowrap; font-weight:400; color: #bbd672;">Comming soon
                  </span>
                  <div class="text-center pt-30 pb-30">
                    <i class="fa fa-cc-paypal text-white font-60"></i>
              ...
              <div
                ...
                <div class="sm-height-auto bg-theme-colored-darker4">
                  <div class="text-center pt-30 pb-30">
                    <i class="fa fa-mobile text-white font-60"></i>
                    <h4 class="text-uppercase mt-20"><a href="#" class="text-white">Call 07791283554</a></h4>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="section-content">
            <div class="row">
              <div class="col-md-8 col-sm-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                <h3 class="text-uppercase mt-0">Welcome To <span class="text-theme-color-2"> Aliz-Driving School </span>
                </h3>
                <p class="lead">At <b>ALIZ DRIVING SCHOOL</b>, we provide top-quality driving instruction that goes
                  beyond simply passing the test. Our mission is to create confident, safe, and responsible drivers who
                  are fully prepared for the road. With experienced, patient instructors and customized lesson plans
                  tailored to each learner’s unique needs, we ensure a supportive and engaging learning environment for
                  drivers of all levels.</p>
                <div class="row mt-40">
              ...
              <div class="col-md-4 col-sm-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="p-30 bg-theme-colored mt-10">
                  ...
                  <form id="reservation_form" name="reservation_form" class="reservation-form mt-20" method="post"
                    action="#">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group mb-20">
                          <input placeholder="Enter Name" type="text" id="reservation_name" name="reservation_name"
                            required="" class="form-control">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group mb-20">
                          <input placeholder="Email" type="text" id="reservation_email" name="reservation_email"
                            class="form-control" required="">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group mb-20">
                          <input placeholder="Phone" type="text" id="reservation_phone" name="reservation_phone"
                            class="form-control" required="">
                        </div>
                      </div>
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <textarea placeholder="Enter Message" rows="3" class="form-control required"
                            name="form_message" id="form_message" aria-required="true"></textarea>
                        </div>
                      </div>
                      <div class="col-sm-12">
                        <div class="form-group mb-0 mt-10">
                          <input name="form_botcheck" class="form-control" type="hidden" value="">
                          <button type="submit" class="btn btn-colored btn-default text-black btn-lg btn-block"
        ...
        <div class="container-fluid pt-0 pb-0">
          <div class="row equal-height">
              ...
              <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
                ...
                <div class="icon-box clearfix m-0 p-0 pb-10">
                  ...
                  <div class="ml-120 ml-sm-0">
                    <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">Experienced & Friendly Instructors
                    </h4>
                    <p class="text-white">Our professional instructors are committed to making learning a positive
                      experience.</p>
                  </div>
                </div>
                <div class="icon-box clearfix m-0 p-0 pb-10">
                  ...
                  <div class="ml-120 ml-sm-0">
                    <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">Tailored Lessons</h4>
                    <p class="text-white">Each session is customized to suit your skill level and learning pace.</p>
                  </div>
                </div>
                <div class="icon-box clearfix m-0 p-0 pb-10">
                  <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none">
                  ...
                  <div class="ml-120 ml-sm-0">
                    <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">Focus on Safety:
                    </h4>
                    <p class="text-white">We prioritize teaching safe driving habits to ensure you’re ready for any road
                      condition.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-6 p-0 bg-img-cover wow fadeInRight hidden-xs"
              data-bg-img="images/photos/ab1.jpg" data-wow-duration="1s" data-wow-delay="0.3s">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="section-title text-center">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <p>At ALIZ, we’re passionate about helping you succeed, whether you're aiming to pass your test, improve
                  your driving, or gain extra confidence on the road. Join us, and let’s get you driving!</p>
              </div>
            </div>
          </div>
                ...
                <div class="item">
                  <div class="project mb-30 border-2px">
                    ...
                    <div class="project-details p-15 pt-10 pb-10">
                      <h5 class="font-14 font-weight-500 mb-5">Pay as you learn</h5>
                      <h4 class="font-weight-700 text-uppercase mt-0"><a
                          href="page-courses-accounting-technologies.html">MANUAL CAR</a></h4>
                      <p>
                      <ul>
                        <li>First lesson (2 hours) – £72
                        </li>
                        <li>Lessons thereafter (minimum 2 hours) – £37.50 p/h</li>
                      </ul>
                      </p>
                      <ul class="list-inline project-conditions text-center m-0 p-10">
                        <li class="current-fund"><strong>Time</strong>Join anytime</li>
                        <li class="target-fund"><strong>Discount</strong>15%</li>
                        <li class="remaining-days"><strong>Duration</strong>as you want</li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="item">
                  <div class="project mb-30 border-2px">
                    ...
                    <div class="project-details p-15 pt-10 pb-10">
                      <h5 class="font-14 font-weight-500 mb-5">Pay as you learn</h5>
                      <h4 class="font-weight-700 text-uppercase mt-0"><a
                          href="page-courses-accounting-technologies.html">AUTOMATIC CAR</a></h4>
                      <p>
                      <ul>
                        <li>First lesson (2 hours) – £67
                        </li>
                        <li>Lessons thereafter (minimum 2 hours) – £35 p/h</li>
                      </ul>
                      </p>
                      <ul class="list-inline project-conditions text-center m-0 p-10">
                        <li class="current-fund"><strong>Time</strong>Join anytime</li>
          ...
          <div class="section-title mb-30">
            <div class="row">
              <div class="col-md-6 col-md-offset-3 text-center">
                <h2 class="mt-0 line-height-1 text-center mb-10 text-white text-uppercase">Block Booking Driving Lessons
                </h2>
                <h1 class="text-theme-color-2">Discounts-</h1>
                <h3 class="text-white">Block Book Driving Lessons Near Me</h3>
                <h3 class="text-white">Block Booking Driving Lessons Prices</h3>
              </div>
            </div>
          </div>
          <div class="section-content">
            <div class="row">
              <div class="col-xs-12 col-sm-10 col-md-10 mb-30 wow fadeInRight" data-wow-duration="1s"
                data-wow-delay="0.5s">
                <div class="pricing table-horizontal maxwidth400">
                  <div class="row">
                    ...
                    <div class="col-md-6 p-30 pl-sm-50">
                      <h4 class="mt-0 mb-5"><a href="#" class="text-white">MANUAL CAR</a></h4>
                      ...
                      <b>
                        <ul class="mb-0 mt-15 text-white">
                          <li>10 Hours (Special Offer) – £355</li>
                          <li>10 Hours (Additional) – £365</li>
                          <li>15 Hours – £543.75</li>
                          <li>20 Hours – £720.00</li>
                          <li>25 Hours – £887.50</li>
                          <li>30 Hours – £1065.00</li>
                          <li>35 Hours – £1225.00</li>
                          <li>40 Hours – £1400.00</li>
                        </ul>
                      </b>
              ...
              <div class="col-xs-12 col-sm-10 col-md-10 mb-30 wow fadeInRight" data-wow-duration="1s"
                ...
                <div class="pricing table-horizontal maxwidth400">
                  <div class="row">
                    ...
                    <div class="col-md-6 p-30 pl-sm-50">
                      <h4 class="mt-0 mb-5"><a href="#" class="text-white">AUTOMATIC CAR</a></h4>
                      <ul class="list-inline mb-5 text-white">
                        <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2016 |</li>
                        <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>New York</li>
                      </ul>
                      <!-- <p class="mb-15 mt-15 text-white">Lorem ipsum dolor sit amet, consectetur adi isicing elit. Quas
                        eveniet, nemo dicta. Ullam nam.</p> -->

                      <b>
                        <ul class="mb-0 mt-15 text-white">
                          <li>10 Hours – £340.00</li>
                          <li>15 Hours – £506.25</li>
                          <li>20 Hours – £670.00</li>
                          <li>25 Hours – £825.00</li>
                          <li>30 Hours – £990.000</li>
                          <li>35 Hours – £1137.50</li>
                          <li>40 Hours – £1300.00</li>
                        </ul>
                      </b>
                      <!-- <a class="text-white font-weight-600" href="#">Read More →</a> -->
                    </div>
                ...
                <div class="pricing table-horizontal maxwidth400">
                  <div class="row">
                    ...
                    <div class="col-md-6 p-30 pl-sm-50">
                      ...
                      <b>
                        <ul class="mb-0 mt-15 text-white">
                          <li>Pass plus course: £250</li>
                          <li>Motorway lessons: £37.5 p/h</li>
                          <li>Refresher Lessons: £37.5 p/h</li>
                          <li>
                            <h5 class="text-theme-color-2">Become driving instructor with us: ask for details</h5>
                          </li>
                          <li>
                            <p>(full training and work provided)</p>
                          </li>
                        </ul>
                      </b>
                      <!-- <a class="text-white font-weight-600" href="#">Read More →</a> -->
          ...
          <div class="section-title text-center">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <p class="pb-0 mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem
                  obcaecati!</p>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                ...
                <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
                  ...
                  <div class="gallery-item campus">
                    <div class="thumb">
                      <img class="img-fullwidth" src="images/gallery/1.jpeg" alt="project">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/1.jpeg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                  ...
                  <div class="gallery-item photos students">
                    <div class="thumb">
                      <img class="img-fullwidth" src="images/gallery/2.jpeg" alt="project">
                      <div class="overlay-shade"></div>
                      <div class="text-holder">
                        <div class="title text-center">Sample Title</div>
                      </div>
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/2.jpeg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item campus">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/3.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item photos">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/4.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item campus students">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/5.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item students">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/6.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item photos">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/7.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="gallery-item students">
                    <div class="thumb">
                      ...
                      <div class="icons-holder">
                        <div class="icons-holder-inner">
                          <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                            <a href="images/gallery/8.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i
                                class="fa fa-picture-o"></i></a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="item">
                  <div class="testimonial-wrapper text-center">
                    ...
                    <div class="content pt-10">
                      <p class="lead text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque est
                        quasi, quas ipsam, expedita placeat facilis odio illo ex accusantium eaque itaque officiis et
                        sit. Vero quo, impedit neque.</p>
                ...
                <div class="item">
                  <article class="post clearfix maxwidth600 mb-sm-30 wow fadeInRight" data-wow-delay=".2s">
                      ...
                      <div class="entry-meta meta-absolute text-center pl-10 pr-10">
                        <div class="display-table">
                          <div class="display-table-cell">
                            <ul>
                              <li><a class="text-white" href="#"><i class="fa fa-comments-o mt-0 pt-0"></i> 85 <br>
                                  comments</a></li>
                              <li><a class="text-white" href="#"><i class="fa fa-thumbs-o-up mt-20"></i> 250 <br>
                                  Likes</a></li>
                            </ul>
                          </div>
                        </div>
                    ...
                    <div class="entry-content border-1px p-20">
                      ...
                      <span class="text-theme-colored mr-10 font-14">Admin | <i
                          class="fa fa-calendar mr-5 text-theme-colored"></i> 21 February 2016</span>
                      <p class="text-left mb-20 mt-5 font-13">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <div data-address="121 King Street, Melbourne Victoria 3000 Australia"
                  data-popupstring-id="#popupstring1" class="map-canvas autoload-map" data-mapstyle="style8"
                  data-height="353" data-latlng="-37.817314,144.955431" data-title="sample title" data-zoom="12"
              ...
              <div class="col-md-7">
                ...
                <form id="contact_form" name="contact_form" class="" action="#" method="post">
                  ...
                  <div class="form-group mb-30">
                    ...
                    <button type="reset"
                      class="btn btn-flat btn-theme-colored text-uppercase mt-20 mb-sm-30 border-left-theme-color-2-4px">Reset</button>
                  </div>
                </form>
    ...
    <footer id="footer" class="footer bg-black-222" data-bg-img="images/footer-bg.png">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3">
            <div class="widget dark">
              <img class="mt-10 mb-15" alt="" src="images/logo-wide.jpg">
              <p class="font-16 mb-10">At ALIZ, we’re passionate about helping you succeed, whether you're aiming to pass your test, improve your driving, or gain extra confidence on the road. Join us, and let’s get you driving!</p>
              ...
              <ul class="styled-icons icon-dark mt-20">
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".1s" data-wow-offset="10"><a
                    href="https://www.facebook.com/ALIZ.DRIVINGSCHOOL" target="_blank" data-bg-color="#3B5998"><i class="fa fa-facebook"></i></a></li>
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".4s" data-wow-offset="10"><a
                    href="https://www.instagram.com/aliz.drivingschool?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" data-bg-color="#A11312"><i class="fa fa-instagram"></i></a></li>
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".5s" data-wow-offset="10"><a
                    href="https://www.youtube.com/@aliz.drivingschool" data-bg-color="#C22E2A"><i class="fa fa-youtube"></i></a></li>
          ...
          <div class="col-sm-6 col-md-3 ml-50">
            <div class="widget dark ">
              <h4 class="widget-title line-bottom">Social Media Links</h4>
              <ul class="list angle-double-right styled-icons icon-dark mt-20 text-white align-cntr">
                <li class="wow fadeInLeft align-cntr" data-wow-duration="1.5s" data-wow-delay=".1s" data-wow-offset="10"><a
                    href="https://www.facebook.com/ALIZ.DRIVINGSCHOOL" target="_blank" data-bg-color="#3B5998"><i class="fa fa-facebook"></i></a><span class="rambod"> Facebook</span></li>
                <hr class="mt-0 mb-0">
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".4s" data-wow-offset="10"><a
                    href="https://www.instagram.com/aliz.drivingschool?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" data-bg-color="#A11312"><i class="fa fa-instagram"></i></a><span class="rambod"> Instagram</span></li>
                <hr class="mt-0 mb-0">
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".5s" data-wow-offset="10"><a href="https://www.youtube.com/@aliz.drivingschool" data-bg-color="#C22E2A" target="_blank"><i class="fa fa-youtube"></i></a><span class="rambod"> Youtube</span></li>
                <hr class="mt-0 mb-0">
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s" data-wow-offset="10"><a
                    href="#" data-bg-color="#02B0E8"><i class="fa fa-twitter"></i></a><span class="rambod"> Twitter</span></li>
                <hr class="mt-0 mb-0">
                <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".3s" data-wow-offset="10"><a
                    href="#" data-bg-color="#05A7E3"><i class="fa fa-skype"></i></a> <span class="rambod"> Skype</span></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6 col-md-3 ml-50">
            <div class="widget dark">
              ...
              <ul class="list-border">
                <li><a href="#">07791283554</a></li>
                <li><a href="#">amjadani@live.com</a></li>
                <li><a href="#" class="lineheight-20">Post code: IG1 1EX, Ilford London, England</a></li>
              </ul>
      ...
      <div class="footer-bottom bg-black-333">
        <div class="container pt-20 pb-20">
          <div class="row">
            <div class="col-md-6">
              <p class="font-11 text-black-777 m-0"><a target="_blank" href="https://www.templateshub.net">Templates
                  Hub</a></p>
            </div>
